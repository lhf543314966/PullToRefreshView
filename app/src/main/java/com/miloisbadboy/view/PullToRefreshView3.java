...
public class PullToRefreshView3 extends LinearLayout {
	...
	public PullToRefreshView3(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
...
//		mHeaderView = mInflater.inflate(R.layout.refresh_header, this, false);
		mHeaderView = mInflater.inflate(R.layout.refresh_header,null);
